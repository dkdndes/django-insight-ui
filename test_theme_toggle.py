...
def test_theme_toggle_functionality(page: Page, live_server_url: str) -> None:
    ...
    has_dark_class_initial = html_element.evaluate(
    ...
    if theme_toggle.count() > 0:
        ...
        has_dark_class_after = html_element.evaluate(
            "el => el.classList.contains('dark')"
        )
        ...
        if initial_theme == "light":
            ...
            assert not has_dark_class_after, (
        ...
        has_dark_class_final = html_element.evaluate(
            "el => el.classList.contains('dark')"
        )
        ...
        assert has_dark_class_final == has_dark_class_initial, (
...
def test_theme_persistence(page: Page, live_server_url: str) -> None:
    ...
    if theme_toggle.count() > 0:
        ...
        assert stored_theme in ["light", "dark"], (
        ...
        assert reloaded_storage == stored_theme, (
...
def test_javascript_console_errors(page: Page, live_server_url: str) -> None:
...
def test_navbar_structure(page: Page, live_server_url: str) -> None:
