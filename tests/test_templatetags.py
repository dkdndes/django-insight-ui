...
@pytest.mark.django_db
def test_card_with_image_and_actions():
...
def test_form_tag():
    ...
    template = Template(
        "{% load insight_tags %}"
        "{% form title='Kontaktformular' fields=fields %}"
    )
...
@pytest.mark.django_db
def test_form_with_textarea_and_select():
